...
// DELETE CART ITEM (FIX)
export const DELETE_CART_ITEM = BASE_URL + "customer/deletecart?cart_id=";

// EMPTY CART
export const EMPTY_CART = BASE_URL + "customer/emptycart?customer_id=";

// 🔥 FIXED - NO QUERY PARAM HERE
export const CREATE_ORDER = BASE_URL + "customer/orders";
